<nav class="navbar shadow-xl" style="background-color: #8423FF;">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" style="color: white;"
            ...
            <div class="offcanvas-header" style="background-color: #8423FF; color: white; padding: 8px">
            ...
            <div class="offcanvas-footer" style="background-color: #8D99AE; color: white;">
                <div class="grid ps-4" style="padding: 13px">
                    <h6>
                        <i class="bi bi-person-lines-fill"></i> Loged In As : Admin
                    </h6>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\Sekolah\Kelas11\TEFA\--FINAL_PROJECT--\Git-Laravel\Thrift_App\resources\views/layouts/nav_admin.blade.php ENDPATH**/ ?>